...
import supabase from "../supabase/client"; // default export
...
export default async function generateSeatingPDF(jsonData) {
  ...
  for (let hIndex = 0; hIndex < hallOrder.length; hIndex++) {
    ...
    // Prepare roll numbers for each group
    ...
    // Group students by year & dept for alternating seating
